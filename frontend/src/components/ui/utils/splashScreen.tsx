        ...
        <div className="flex flex-col items-center space-y-8">
          ...
          <div className={`transform transition-all duration-700 ${
            ...
            <div className="w-32 h-32 md:w-48 md:h-48 flex items-center justify-center">
              <img src={logo} alt="CareerBoost Logo" className="w-full h-full object-contain" />
            </div>
          </div>
          ...
          <div className="w-full space-y-4">
            <div
              className="w-full bg-blue-50 rounded-full overflow-hidden shadow-inner border border-blue-100"
              role="progressbar"
            ...
            >
              ...
              >
                {/* Shimmer effect */}
                <div
                  className="absolute inset-0 bg-linear-to-r from-transparent via-white/40 to-transparent transform -skew-x-12"
                  style={{
